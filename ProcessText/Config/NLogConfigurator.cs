    ...
    public class NLogConfigurator
    {
        ...
        public static void AddDebugger()
        {
            ...
            if (logDebugger == null)
            {
                ...
                LogManager.Configuration.AddRule(ConfigurationService.Current.LogLevel, LogLevel.Fatal, logDebugger);
            }

            // Refresh log levels
            foreach (var rule in LogManager.Configuration.LoggingRules.Where(x => x.Targets.Contains(logDebugger)))
            {
                rule.SetLoggingLevels(ConfigurationService.Current.LogLevel, LogLevel.Fatal);
            }
        ...
        public static void AddRollingFile()
        {
            ...
            if (logFile == null)
            {
                ...
                LogManager.Configuration.AddRule(ConfigurationService.Current.LogLevel, LogLevel.Fatal, logFile);
            }
        ...
        /// <summary>
        /// Reconfigures all loggers with configuration from <see cref="ServiceConfiguration"/>.
        /// </summary>
