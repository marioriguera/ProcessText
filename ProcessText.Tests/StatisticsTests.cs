...
namespace ProcessText.Tests
{
    ...
    public class StatisticsTests
    {
        ...
        {
            // Obtain the ITextAnalyzer from the service collection
            _textAnalyzer = ConfigurationServiceTests.Current.TestHost.Services.GetRequiredService<ITextAnalyzer>();
        }
